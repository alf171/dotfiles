...
-- hide mode since status bar already has it
vim.o.showmode = false

-- Share clipboard with os and nvim
...
-- Preview substitutions live (:%s/a/b)
...
require('lazy').setup({
    ...
    config = function()
      ...
      local servers = {
        clangd = {
          ...
          -- no init_options needed if you have .clangd in the project
        },
        lua_ls = {
  ...
  -- TODO: remove and move to plugin dir
